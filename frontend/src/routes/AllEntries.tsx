      ...
      {entries.map((entry: Entry, index: number) => {
        return (
          <div
            id={entry.id}
            key={index}
            className="bg-gray-300 dark:bg-gray-500 shadow-md shadow-gray-500 dark:shadow-gray-300 m-3 p-4 rounded flex flex-col justify-between"
          >
            ...
            <section className="flex items-center justify-between flex-col md:flex-row pt-2 md:pt-0">
              <div className="flex justify-center">
                ...
                <button
                  ...
                  className="m-1 md:m-2 p-1 font-semibold rounded-md bg-blue-500 hover:bg-blue-700 dark:bg-gray-700 dark:hover:bg-blue-900"
                >
                  🖊
                </button>
              </div>
